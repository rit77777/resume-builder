  ...
  <html>
    ...
    <body>
      <div class="col-lg-8 mx-auto">
        ...
        <div class="col-lg-8 mx-auto">
          <p class="lead">
            <b>${experienceOrganization1}, ${experiencePosition1}</b>
            (${experienceDescription1})
          </p>
        ...
        <div class="col-lg-8 mx-auto">
          <p class="lead">
            <b>${experienceOrganization2}, ${experiencePosition2}</b>
            (${experienceDescription2})
          </p>
        ...
        <div class="col-lg-8 mx-auto">
          <p class="lead">
            <b>${college}</b> (${collegeQualification}, ${collegeYear})
          </p>
          <p class="mt-0">${collegeDescription}</p>
        </div>
        <div class="col-lg-8 mx-auto">
          <p class="lead">
            <b>${school}</b> (${schoolQualification}, ${schoolYear})
          </p>
        ...
        <div class="col-lg-8 mx-auto">
          <ul>
            <li>
              <p class="lead"><b>Languages: </b>${extras1}</p>
            </li>
            <li>
              <p class="lead"><b>Hobbies: </b>${extras2}</p>
            </li>
